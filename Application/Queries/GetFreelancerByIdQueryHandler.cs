...
public class GetFreelancerByIdQueryHandler : IRequestHandler<GetFreelancerByIdQuery, CreateFreelancerResponse?>
{
    private readonly IFreelancerRepository _repository;

    public GetFreelancerByIdQueryHandler(IFreelancerRepository repository)
    {
    ...
    {
        var freelancer = await _repository.GetByIdAsync(request.Id);
